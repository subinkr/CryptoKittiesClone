...
describe("KittyCore & SaleClockAuction", () => {
    ...
    describe("KittyCore Constructor", () => {
        ...
        it("KittyMinting values check", async () => {
            ...
            console.log(`promo kitty count: ${promoKittyCount}, gen0 kitty count: ${gen0KittyCount}`);

            expect(promoKittyCount).to.equal(0);
            expect(gen0KittyCount).to.equal(0);
        });

        it("Kittycore Constuctor", async () => {
    ...
    describe("CloneAuction Constructor", () => {
    ...
    describe("KittyMinting", () => {
        ...
        it("Gen0 Kitty's current price should be halved when time passed half to expiration", async () => {
            console.log(">>> befor time passed half day");
    ...
    describe("SaleClockAuction", () => {
        ...
        it("bit gen0 1", async () => {
            ...
            console.log(`KittyCore balance bef: ${kittyCoreBal_bef}`);
            ...
            console.log(`KittyCore balance bef: ${kittyCoreBal_aft}`);
        ...
        it("createAuction should fail if it's not called by nonFungibleContract(KittyCore)", async () => {
            ...
            const oneDay = 86400;
            await expect(saleClockAuction.connect(signers[2])
                .createAuction(3, startingPrice, endingPrice, oneDay, signers[2].address)).to.be
                .revertedWith("you're not the nonFungibleContract");
    ...
    describe("User Create Auction", () => {
        it("Should revert if user tries to createAuction when contract is paused", async () => {
            ...
            await expect(kittyCore.connect(signers[2]).createSaleAuction(1, startingPrice, endingPrice,duration))
        ...
        it("User create auction correctly", async () => {
            ...
            console.log(">>> after crateSaleAuction by signer 2");
    ...
    describe("CancelAuction", () => {
        it("Should revert if the tokenId is not on the auction", async() => {
            await expect(saleClockAuction.connect(signers[3]).cancelAuction(1))
                .to.be.revertedWith("this _tokenId is not on the auction");
        });
        ...
        it("CancelAuction correctly", async () => {
            ...
            console.log(">>> cancle sale auction");
    ...
    describe("WithdrawBalance", () => {
        ...
        it("Withdraw balance from KittyCore to CFO", async () => {
            console.log(">>> before withdrawBalance from KittyCore");
            ...
            console.log(`cfo balance before: ${cfoBal_bef}`);
            ...
            console.log(`cfo balance before: ${cfoBal_aft}`);
